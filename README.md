...
| GET / PUT / PATCH / DELETE | `/api/projects/{id}/places/{place_pk}/` | Деталі зупинки / нотатки та відвідування / видалення з маршруту |

Видалення зупинки доступне власнику маршруту та повертає `204`. Воно прибирає також нотатку й позначку відвідування цієї зупинки; сам маршрут, закладки та такі самі місця в інших маршрутах зберігаються.
